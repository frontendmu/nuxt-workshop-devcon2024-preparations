...
async function prepareVueTsc() {
  ...
  try {
    ...
    const targetTsVersion = _require(import_node_path.default.resolve(targetTsDir, "package.json")).version;
  ...
  if (shouldBuildFixture) {
    ...
    await overrideTscJs(_require.resolve(import_node_path.default.resolve(targetTsDir, "lib/typescript.js")));
  }
  return { targetTsDir };
}
