<template>
    <div>
        <input id="checkbox-input" type="checkbox" class="switch" checked />
        <label class="switch" for="checkbox-input">
            <svg xml:space="preserve" style="enable-background:new 0 0 128 128" viewBox="0 0 128 128" height="3em"
...
#checkbox-input:checked+.switch {
    box-shadow: inset 0px 0px 32px rgb(255, 255, 110, 0.2);
}
</style>